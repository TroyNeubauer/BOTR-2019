...
void setup() {
  ...
  while (1) {
    ...
    int error = 0;
    error = myCAM.wrSensorReg8_8(0xff, 0x01);
    Serial.print("Error");
    Serial.println(error);
    error != myCAM.rdSensorReg8_8(OV2640_CHIPID_HIGH, &vid);
    Serial.print("Error");
    Serial.println(error);
    error != myCAM.rdSensorReg8_8(OV2640_CHIPID_LOW, &pid);
    Serial.print("Error");
    Serial.println(error);
    if ((vid != 0x26 ) && (( pid != 0x41 ) || ( pid != 0x42 ))) {
      Serial.println(F("ACK CMD Can't find OV2640 module! END"));
      Serial.print(F("Data vid: "));
      Serial.print(vid);
      Serial.print(F(", pid: "));
      Serial.println(pid);
      delay(1000); continue;
